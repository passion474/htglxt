...
import {
  ...
  delUserApi,
  exportUserApi,
} from '@service/system/organize/user'
import { useModal } from '@/components/Modal'
import { useMessage } from '@/hooks/web/useMessage'
import { IconEnum, UserTypeEnum } from '@admin/tokens'
...
import { UserPM } from '@type/system'
import UserResPwdModal from '@/views/system/organize/user/UserResPwdModal.vue'
...
export default defineComponent({
  ...
  setup() {
    ...
    function handleHidden(record: Recordable) {
      return !(
        isEqual(record.userType, UserTypeEnum.ADMIN) &&
        useUserStore().isNotAdmin
      )
    }
