...
import { listSourceApi, delSourceApi } from '@service/tenant/source/source'
...
export default defineComponent({
  ...
  components: { BasicTable, SourceModal, TableAction },
  setup() {
