    ...
    <div class="step-form-form">
      ...
      <div class="mt-5">
        <BasicForm
          ...
          v-show="current === tenantInitList[0].current"
        />
        <BasicForm
          @register="tenantRegister"
          v-show="current === tenantInitList[1].current"
        />
        <BasicForm
          @register="organizeRegister"
          v-show="current === tenantInitList[2].current"
        />
        <BasicForm
          @register="authorityRegister"
          v-show="current === tenantInitList[3].current"
        >
...
import { addTenantApi, authScopeTenantApi } from '@service/tenant/tenant/tenant'
...
export default defineComponent({
  ...
  setup(_, { emit }) {
    ...
    const [
      strategyRegister,
      { resetFields: strategyResetFields, validate: strategyValidate },
    ] = useForm({
      labelWidth: 100,
    ...
    const [
      tenantRegister,
      { resetFields: tenantResetFields, validate: tenantValidate },
    ] = useForm({
      labelWidth: 100,
