...
import { optionDictTypeApi } from '@service/tenant/dict/dictType'
...
import { GenTableColumnIM, GenTableColumnLM, GenTableLM } from '@type/gen'
import { h } from 'vue'
      ...
      return {
        ...
        onChange: async (e: any) => {
          const treeData =
            e === undefined
              ? []
              : await getMenuRouteListApi(e, MenuTypeEnum.DIR)
