<template>
  <PageWrapper :title="getTitle" @back="goBack">
    <template #extra>
      <a-button type="primary" @click="submit" v-auth="GenAuth.EDIT" danger>
        保存
      </a-button>
    </template>
...
import { editGenApi, getSubGenApi } from '@service/gen/generate/gen'
import { useMessage } from '@/hooks/web/useMessage'
import { useTabs } from '@/hooks/web/useTabs'
import { PageWrapper } from '@/components/Page'
import { GenTableIM } from '@type/gen'
...
export default defineComponent({
  ...
  setup() {
    ...
    const state = reactive<{
      ...
      basicRef: { initialize: () => {}, submit: () => {} },
      generateRef: { initialize: () => {}, submit: () => {} },
      fieldRef: { initialize: () => {}, submit: () => {} },
    })
