import type { HeaderSetting } from '@admin/types'
...
export function useHeaderSetting() {
  ...
  const getShowUserCenter = computed(
    () => appStore.getHeaderSetting.showUserCenter,
  )

  const getShowEnterpriseCenter = computed(
    () => appStore.getHeaderSetting.showEnterpriseCenter,
  )
