import { PostIM, PostPPM, PostLRM } from '@admin/types/modules/system'
...
export const listPostApi = (params?: PostPPM) =>
  defaultRequest.get<PostLRM>({ url: Api.LIST_POST, params })

/** 查询岗位选择框列表 */
export const optionPostApi = () =>
  defaultRequest.get<PostLRM>({ url: Api.OPTION_POST })

/** 查询岗位详细 */
export const getPostApi = (id: string | number) =>
  defaultRequest.get<PostIM>({ url: Api.GET_POST, params: id })
...
/** 新增岗位 */
export const addPostApi = (params: PostIM) =>
  defaultRequest.post({ url: Api.ADD_POST, params })

/** 修改岗位 */
export const editPostApi = (params: PostIM) =>
  defaultRequest.put({ url: Api.EDIT_POST, params })

/** 修改岗位的角色权限 */
export const editAuthPostScopeApi = (
  id: string | number,
...
export const delPostApi = (ids: (string | number) | (string | number)[]) =>
  defaultRequest.delete({ url: Api.DEL_BATCH_POST, params: ids.toString() })
